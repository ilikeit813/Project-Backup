...
if __name__ == '__main__':
    ...
    DMstart= 0.1 #1.0 #initial DM trial
    DMend  = 500. #90.0 #finial  DM trial
    ...
    if  pol < 4:
        ...
        while DM < DMend:
            ...
            if rank<npws:#timeseries is ready for signal search
                ranki=rank
                filename = "ppa_SNR_pol_%.1i_td_%.2i_no_%.05i.txt" % (pol,ranki,txtsize[ranki,0])
                ...
                for one in ones:# Now record all pulses above threshold
                    ...
                    if txtsize[ranki,1] >200000*txtsize[ranki,0]:
                        outfile.close()
                        txtsize[ranki,0]+=1
                        filename = "ppa_SNR_pol_%.1i_td_%.2i_no_%.05d.txt" % (pol,ranki,txtsize[ranki,0])
                        outfile = open(filename,'a')
